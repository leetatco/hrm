...
<script>
	...
	export default {
		...
		methods: {
			...
			addBtn() {
				this.resetForm();
				this.form1.props.action = 'admin/hrm/attendance/sys/punchrule/add';
			...
			updateBtn({
				...
				this.form1.props.action = 'admin/hrm/attendance/sys/punchrule/update';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/hrm/attendance/sys/punchrule/delete",
					data: {
						_id: item._id
					}
				});
