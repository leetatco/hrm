			...
			return {
				...
				table1: {
					...
					columns: [{
						...
						{
							key: "form_data.expected_repay_date",
							title: "预计还款日期",
							type: "date",
		...
		methods: {
			...
			async handleFormSubmit(formData) {
				...
				try {
					...
					const title = formData.form_data.loan_title || `${userInfo.username}的借款申请`;
					const submitData = {
						...formData,
						userInfo,
						title,
