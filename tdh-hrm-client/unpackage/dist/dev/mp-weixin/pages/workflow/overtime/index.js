...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    v: common_vendor.o($options.addBtn, "e1"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "43"),
    H: common_vendor.o($options.handleFormSubmit, "31"),
    I: common_vendor.o($options.handleSimulate, "2a"),
    J: common_vendor.o($options.previewFile, "fb"),
    K: common_vendor.o($options.closeFormDialog, "98"),
    L: common_vendor.o($options.downloadFile, "aa"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "aa"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "45"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "74"),
    V: common_vendor.o($options.downloadFile, "92"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "51"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "af"),
    aa: common_vendor.o($options.cancelDelete, "b6"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "0e"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "f3"),
    ae: common_vendor.o($options.downloadFile, "86"),
    af: common_vendor.p({
