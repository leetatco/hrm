  ...
  methods: {
    ...
    async init() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:418", "初始化失败:", e);
        this.useDefaultFormSchema();
      } finally {
        this.loading = false;
      }
    ...
    handleEdit(item) {
      common_vendor.index.__f__("log", "at pages/workflow/work-clothes/index.vue:699", item);
      const formData = {
        ...item
      };
      if (item.form_data) {
    ...
    async handleFormSave(formData) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:780", "保存失败:", error);
        common_vendor.index.showToast({
          title: "保存失败",
          icon: "none"
        });
    ...
    async handleFormSubmit(formData) {
      ...
      try {
        ...
        const title = ((_b = formData.form_data) == null ? void 0 : _b.clothes_title) || `${(userInfo == null ? void 0 : userInfo.username) || "用户"}的工衣申请`;
        const submitData = {
          ...formData,
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:838", "提交失败:", e);
        common_vendor.index.showToast({
          title: "提交失败",
          icon: "none"
        });
    ...
    async handleSimulate(formData) {
      ...
      try {
        ...
        const simulateData = {
          ...
          calculated_values: calculatedValues,
          process_definition_key: "WORK_CLOTHES_APPLICATION",
          // 根据实际流程定义 key 调整
          userInfo
        };
        const res = await vk.callFunction({
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:884", "试算失败:", e);
        common_vendor.index.showToast({
          title: "试算失败",
          icon: "none"
        });
    ...
    async loadProcessFlow(item) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:939", "加载审批流程失败:", e);
      }
    },
    async loadStatusHistory(item) {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/work-clothes/index.vue:974", "加载状态历史失败:", e);
      }
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.sr("statusFilter", "a59cbe68-0"),
    e: common_vendor.p({
      ["active-color"]: "#2979ff"
    }),
    f: common_vendor.p({
    ...
    q: common_vendor.f($data.tableData, (item, index, i0) => {
      ...
      return common_vendor.e({
        a: "a59cbe68-4-" + i0,
        b: common_vendor.t(((_a = item.form_data) == null ? void 0 : _a.clothes_title) || "未命名工衣申请"),
        ...
        f: common_vendor.t($options.getClothesSummary((_b = item.form_data) == null ? void 0 : _b.items)),
        g: common_vendor.t(((_c = item.form_data) == null ? void 0 : _c.total_quantity) || 0),
    ...
    v: common_vendor.o($options.addBtn, "ae"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "98"),
    H: common_vendor.o($options.handleFormSubmit, "18"),
    I: common_vendor.o($options.handleSimulate, "37"),
    J: common_vendor.o($options.previewFile, "52"),
    K: common_vendor.o($options.closeFormDialog, "9a"),
    L: common_vendor.o($options.downloadFile, "35"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "f8"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "c5"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "5d"),
    V: common_vendor.o($options.downloadFile, "3a"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "d2"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    aa: common_vendor.o($options.cancelDelete, "a2"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "00"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "0d"),
    ae: common_vendor.o($options.downloadFile, "68"),
    af: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a59cbe68"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workflow/work-clothes/index.js.map
