...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    v: common_vendor.o($options.addBtn, "4c"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "a4"),
    H: common_vendor.o($options.handleFormSubmit, "1b"),
    I: common_vendor.o($options.handleSimulate, "e0"),
    J: common_vendor.o($options.previewFile, "0e"),
    K: common_vendor.o($options.closeFormDialog, "7a"),
    L: common_vendor.o($options.downloadFile, "ec"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "6e"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "7e"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "99"),
    V: common_vendor.o($options.downloadFile, "6b"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "34"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "00"),
    aa: common_vendor.o($options.cancelDelete, "b3"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "b4"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "dc"),
    ae: common_vendor.o($options.downloadFile, "ce"),
    af: common_vendor.p({
