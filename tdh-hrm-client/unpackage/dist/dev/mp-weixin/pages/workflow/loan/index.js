...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      queryForm1: {
        formData: {
          form_type_code: "LOAN_APPLICATION",
          status: ""
        }
      },
      formDialog: {
  ...
  methods: {
    ...
    async init() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/loan/index.vue:359", "init error", e);
        this.useDefaultFormSchema();
      } finally {
        this.loading = false;
      }
      ...
      this.formSchema = {
        ...
        layout: {
          ...
          groups: [
            {
              title: "基本信息",
              fields: ["loan_title", "loan_amount", "loan_currency", "expected_repay_date"]
            },
            {
              title: "借款事由",
              fields: ["loan_purpose"],
    ...
    async handleFormSubmit(formData) {
      ...
      try {
        ...
        const submitData = {
          ...formData,
          userInfo,
          title: ((_a = formData.form_data) == null ? void 0 : _a.loan_title) || "借款申请"
        };
        if (formData._id) {
    ...
    async handleSimulate(formData) {
      ...
      try {
        ...
        const simulateData = {
          ...
          process_definition_key: "LOAN_APPLICATION",
          userInfo
        };
        const res = await vk.callFunction({
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.sr("statusFilter", "71c2a868-0"),
    e: common_vendor.p({
      ["active-color"]: "#2979ff"
    }),
    f: common_vendor.p({
    ...
    q: common_vendor.f($data.tableData, (item, index, i0) => {
      ...
      return common_vendor.e({
        a: "71c2a868-4-" + i0,
        b: common_vendor.t(((_a = item.form_data) == null ? void 0 : _a.loan_title) || "未命名借款"),
        ...
        f: common_vendor.t(((_b = item.form_data) == null ? void 0 : _b.loan_amount) || 0),
        g: common_vendor.t(((_c = item.form_data) == null ? void 0 : _c.expected_repay_date) || "未指定"),
    ...
    v: common_vendor.o($options.addBtn, "c6"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    A: $data.refreshing,
    B: common_vendor.o((...args) => $options.onPullDownRefresh && $options.onPullDownRefresh(...args), "47"),
    C: common_vendor.o((...args) => $options.loadMore && $options.loadMore(...args), "89")
  }), {
    ...
    G: common_vendor.o($options.handleFormSave, "38"),
    H: common_vendor.o($options.handleFormSubmit, "6a"),
    I: common_vendor.o($options.handleSimulate, "ef"),
    J: common_vendor.o($options.previewFile, "cd"),
    K: common_vendor.o($options.closeFormDialog, "aa"),
    L: common_vendor.o($options.downloadFile, "a2"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "f1"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "b2"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "61"),
    V: common_vendor.o($options.downloadFile, "cf"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "8f"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "b3"),
    aa: common_vendor.o($options.cancelDelete, "13"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "19"),
    ac: common_vendor.p({
    ...
    ae: common_vendor.o($options.downloadFile, "3e"),
    af: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-71c2a868"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workflow/loan/index.js.map
