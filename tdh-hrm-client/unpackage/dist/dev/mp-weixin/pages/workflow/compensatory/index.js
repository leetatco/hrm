  ...
  methods: {
    ...
    useDefaultFormSchema() {
      this.formSchema = {
        fields: [
          {
            name: "compensatory_title",
            label: "调休标题",
            type: "text",
            required: true,
            placeholder: "如：系统维护调班",
            defaultValue: ""
          },
          {
            ...
            columns: [
              {
                ...
                isUnique: true,
                width: 280,
                action: "admin/bpmn/application-form/sys/getListToCompensatory",
                placeholder: "请选择加班单",
                props: {
                  list: "rows",
                  value: "_id",
        ...
        layout: {
          ...
          groups: [
            {
              title: "调休基本信息",
              fields: ["compensatory_title", "compensatory_date"]
            },
            {
              title: "加班单明细",
              fields: ["items"],
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.sr("statusFilter", "bab2b5fa-0"),
    e: common_vendor.p({
      ["active-color"]: "#2979ff"
    }),
    f: common_vendor.p({
    ...
    q: common_vendor.f($data.tableData, (item, index, i0) => {
      ...
      return common_vendor.e({
        a: "bab2b5fa-4-" + i0,
        b: common_vendor.t(((_a = item.form_data) == null ? void 0 : _a.compensatory_title) || "未命名调休"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-bab2b5fa"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workflow/compensatory/index.js.map
