...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    v: common_vendor.o($options.addBtn, "fa"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "40"),
    H: common_vendor.o($options.handleFormSubmit, "42"),
    I: common_vendor.o($options.handleSimulate, "17"),
    J: common_vendor.o($options.previewFile, "6f"),
    K: common_vendor.o($options.closeFormDialog, "74"),
    L: common_vendor.o($options.downloadFile, "3a"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "50"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "eb"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "0e"),
    V: common_vendor.o($options.downloadFile, "0d"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "f2"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "5b"),
    aa: common_vendor.o($options.cancelDelete, "b8"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "bb"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "67"),
    ae: common_vendor.o($options.downloadFile, "bb"),
    af: common_vendor.p({
