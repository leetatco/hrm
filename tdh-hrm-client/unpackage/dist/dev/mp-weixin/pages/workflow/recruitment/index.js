...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    v: common_vendor.o($options.addBtn, "1f"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "63"),
    H: common_vendor.o($options.handleFormSubmit, "4e"),
    I: common_vendor.o($options.handleSimulate, "38"),
    J: common_vendor.o($options.previewFile, "e6"),
    K: common_vendor.o($options.closeFormDialog, "d3"),
    L: common_vendor.o($options.downloadFile, "e9"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "dc"),
    O: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "5e"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "fa"),
    V: common_vendor.o($options.downloadFile, "7e"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "05"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "ca"),
    aa: common_vendor.o($options.cancelDelete, "b4"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "97"),
    ac: common_vendor.p({
    ...
    ae: common_vendor.o($options.downloadFile, "d0"),
    af: common_vendor.p({
