...
const _sfc_main = {
  ...
  methods: {
    ...
    getResignationTypeText(type) {
      common_vendor.index.__f__("log", "at pages/workflow/resignation/index.vue:320", "type:", type);
      const map = {
        voluntary: "主动离职",
        involuntary: "被动离职",
        contract_end: "合同到期",
    ...
    async init() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/resignation/index.vue:369", "init error", e);
        this.useDefaultFormSchema();
      } finally {
        this.loading = false;
      }
    ...
    async handleFormSubmit(formData) {
      ...
      try {
        ...
        const submitData = {
          ...formData,
          userInfo,
          title: ((_a = formData.form_data) == null ? void 0 : _a.resignation_title) || "离职申请"
        };
        if (formData._id) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.sr("statusFilter", "0bca7bcf-0"),
    e: common_vendor.p({
      ["active-color"]: "#2979ff"
    }),
    f: common_vendor.p({
    ...
    q: common_vendor.f($data.tableData, (item, index, i0) => {
      ...
      return common_vendor.e({
        a: "0bca7bcf-4-" + i0,
        b: common_vendor.t(((_a = item.form_data) == null ? void 0 : _a.resignation_title) || "未命名离职"),
        ...
        f: common_vendor.t(((_b = item.form_data) == null ? void 0 : _b.type_name) || ((_c = item.form_data) == null ? void 0 : _c.resignation_type)),
        g: common_vendor.t(((_d = item.form_data) == null ? void 0 : _d.resignation_date) || "未指定"),
    ...
    v: common_vendor.o($options.addBtn, "f1"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "18"),
    H: common_vendor.o($options.handleFormSubmit, "9e"),
    I: common_vendor.o($options.handleSimulate, "87"),
    J: common_vendor.o($options.previewFile, "15"),
    K: common_vendor.o($options.closeFormDialog, "ea"),
    L: common_vendor.o($options.downloadFile, "53"),
    M: common_vendor.p({
    ...
    N: common_vendor.o(($event) => $data.formDialog.show = $event, "cc"),
    O: common_vendor.p({
    ...
    U: common_vendor.o($options.previewFile, "eb"),
    V: common_vendor.o($options.downloadFile, "f8"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "47"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "a7"),
    aa: common_vendor.o($options.cancelDelete, "46"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "98"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "d1"),
    ae: common_vendor.o($options.downloadFile, "78"),
    af: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0bca7bcf"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workflow/resignation/index.js.map
