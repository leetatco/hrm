  ...
  methods: {
    ...
    async init() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:423", "初始化失败:", e);
        this.useDefaultFormSchema();
      } finally {
        this.loading = false;
      }
    ...
    async handleFormSave(formData) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:840", "保存失败:", error);
        common_vendor.index.showToast({
          title: "保存失败",
          icon: "none"
        });
    ...
    async handleFormSubmit(formData) {
      ...
      try {
        ...
        const employeeCount = ((_b = (_a = formData.form_data) == null ? void 0 : _a.items) == null ? void 0 : _b.length) || 0;
        const calculatedValues = {
          employee_count: employeeCount,
          transfer_type: (_c = formData.form_data) == null ? void 0 : _c.transfer_type
        };
        const title = `${(userInfo == null ? void 0 : userInfo.username) || "用户"}的人事调动申请 - ${this.getTransferTypeLabel((_d = formData.form_data) == null ? void 0 : _d.transfer_type)}`;
        const submitData = {
          ...formData,
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:889", "提交失败:", e);
        common_vendor.index.showToast({
          title: "提交失败",
          icon: "none"
        });
    ...
    async handleSimulate(formData) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:928", "试算失败:", e);
        common_vendor.index.showToast({
          title: "试算失败",
          icon: "none"
        });
    ...
    async loadProcessFlow(item) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:983", "加载审批流程失败:", e);
      }
    },
    async loadStatusHistory(item) {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/workflow/transfer/index.vue:1018", "加载状态历史失败:", e);
      }
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.sr("statusFilter", "4d2f59fc-0"),
    e: common_vendor.p({
      ["active-color"]: "#2979ff"
    }),
    f: common_vendor.p({
    ...
    q: common_vendor.f($data.tableData, (item, index, i0) => {
      ...
      return common_vendor.e({
        a: "4d2f59fc-4-" + i0,
        b: common_vendor.t($options.getTransferTypeLabel((_a = item.form_data) == null ? void 0 : _a.transfer_type)),
        ...
        f: common_vendor.t(((_c = (_b = item.form_data) == null ? void 0 : _b.items) == null ? void 0 : _c.length) || 0),
        g: common_vendor.t(((_d = item.form_data) == null ? void 0 : _d.effective_date) || "未指定"),
    ...
    v: common_vendor.o($options.addBtn, "16"),
    w: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    G: common_vendor.o($options.handleFormSave, "99"),
    H: common_vendor.o($options.handleFormSubmit, "61"),
    I: common_vendor.o($options.handleSimulate, "0d"),
    J: common_vendor.o($options.previewFile, "ab"),
    K: common_vendor.o($options.closeFormDialog, "53"),
    L: common_vendor.o($options.downloadFile, "7a"),
    M: common_vendor.p({
    ...
    Q: common_vendor.o(($event) => $data.simulateDialog.show = $event, "39"),
    R: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    U: common_vendor.o($options.previewFile, "3b"),
    V: common_vendor.o($options.downloadFile, "40"),
    W: common_vendor.p({
    ...
    X: common_vendor.o(($event) => $data.detailDialog.show = $event, "92"),
    Y: common_vendor.p({
      mode: $data.popupStyle.mode,
      closeable: true,
      ["border-radius"]: $data.popupStyle.border_radius,
    ...
    Z: common_vendor.o($options.confirmDelete, "77"),
    aa: common_vendor.o($options.cancelDelete, "6a"),
    ab: common_vendor.o(($event) => $data.deleteDialog.show = $event, "45"),
    ac: common_vendor.p({
    ...
    ad: common_vendor.o($options.filePreviewClose, "5f"),
    ae: common_vendor.o($options.downloadFile, "6e"),
    af: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-4d2f59fc"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workflow/transfer/index.js.map
