  ...
  methods: {
    ...
    async save(formData) {
      ...
      try {
              ...
              success: (modalRes) => {
                if (modalRes.confirm) {
                  vk.userCenter.logout({
                    ...
                    fail: (err) => {
                      common_vendor.index.__f__("error", "at pages/pwd/update-password.vue:255", "退出登录失败:", err);
        ...
        common_vendor.index.__f__("error", "at pages/pwd/update-password.vue:276", "修改密码失败:", e);
        common_vendor.index.showToast({
          title: "网络错误，请稍后重试",
          icon: "none",
          duration: 2e3
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o(($event) => $data.showOldPassword = !$data.showOldPassword, "58"),
    d: common_vendor.p({
      name: $data.showOldPassword ? "eye-fill" : "eye",
      size: "36",
      color: "#909399"
    }),
    e: common_vendor.o(($event) => $data.password.oldPassword = $event, "b8"),
    f: common_vendor.p({
    ...
    i: common_vendor.o(($event) => $data.showNewPassword = !$data.showNewPassword, "15"),
    j: common_vendor.p({
      name: $data.showNewPassword ? "eye-fill" : "eye",
      size: "36",
      color: "#909399"
    }),
    k: common_vendor.o(($event) => $data.password.newPassword = $event, "41"),
    l: common_vendor.p({
    ...
    o: common_vendor.o(($event) => $data.showConfirmPassword = !$data.showConfirmPassword, "f3"),
    p: common_vendor.p({
      name: $data.showConfirmPassword ? "eye-fill" : "eye",
      size: "36",
      color: "#909399"
    }),
    q: common_vendor.o($options.submitForm, "a1"),
    r: common_vendor.o(($event) => $data.password.passwordConfirmation = $event, "1d"),
    s: common_vendor.p({
    ...
    J: common_vendor.o($options.submitForm, "39"),
    K: common_vendor.p({
      type: "primary",
      shape: "circle",
    ...
    L: common_vendor.o((...args) => $options.resetForm && $options.resetForm(...args), "cb"),
    M: common_vendor.p({
      name: "info-circle",
      size: "36",
      color: "#2979ff"
