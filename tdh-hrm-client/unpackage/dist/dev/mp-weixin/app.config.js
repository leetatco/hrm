...
const config = {
  ...
  interceptor: {
    ...
    // 	//uni.__f__('log','at app.config.js:161',"params:",params);
    // 	//uni.__f__('log','at app.config.js:162',"res:",res);
    // 	if(!params.noAlert){
    // 		vk.alert(res.msg);
    // 	}
    // 	uni.__f__('log','at app.config.js:166',"跳自己的登录页面");
    // 	// 上方代码可自己修改，写成你自己的逻辑处理。
    // },
    // fail:function(obj){
    // 	let { vk, params, res } = obj;
    // 	//uni.__f__('log','at app.config.js:172',"params:",params);
    // 	//uni.__f__('log','at app.config.js:173',"res:",res);
