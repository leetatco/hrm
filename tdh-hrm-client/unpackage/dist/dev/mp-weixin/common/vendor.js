...
const subPackages = [
  {
    ...
    pages: [
      ...
      {
        path: "miss-punch-apply/index",
        style: {
          navigationBarTitleText: "签卡申请"
        }
      },
      {
        path: "transfer/index",
        style: {
          navigationBarTitleText: "调动申请"
        }
      },
      {
        path: "recruitment/index",
        style: {
          navigationBarTitleText: "招聘申请"
        }
      },
      {
        path: "leave/index",
      ...
      {
        path: "compensatory/index",
        style: {
          navigationBarTitleText: "调休申请"
        }
      },
      {
        path: "business-trip/index",
        style: {
          navigationBarTitleText: "出差申请"
        }
      },
      {
        path: "resignation/index",
        style: {
      ...
      {
        path: "work-clothes/index",
        style: {
          navigationBarTitleText: "工衣申请"
        }
      },
      {
        path: "outing/index",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        path: "setting_edit",
        style: {
          navigationBarTitleText: "考勤打卡设置表",
          enablePullDownRefresh: false
        }
      },
      {
    ...
    pages: [
      {
        path: "index",
        style: {
          navigationBarTitleText: "薪资列表"
        }
      },
      {
        path: "sign",
        style: {
          navigationBarTitleText: "薪资签名"
        }
      }
    ]
  },
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), T = b, C = I('{"address":["127.0.0.1","192.168.82.31"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","E:/HBuilderX/plugins/unicloud/**/*.js"]}'), P = I('[{"provider":"aliyun","spaceName":"tdh-db","spaceId":"mp-172c1e9f-d637-4510-916b-3f73d0c2de3c","clientSecret":"B1vi2KWj85GiOkR32fR9cA==","endpoint":"https://api.next.bspapp.com","failoverEndpoint":""}]') || [];
let E = "";
try {
  E = "__UNI__ABE8DE0";
} catch (e2) {
...
const validateType = (word) => {
  if (typeof word !== "string") {
    index.__f__("error", "at node_modules/pinyin-pro/dist/index.mjs:24208", "The first param of pinyin is error: " + word + ' is not assignable to type "string".');
    return false;
  } else {
    return true;
  }
