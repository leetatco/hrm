...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.o($options.onSearch, "82"),
    b: common_vendor.o($options.onSearch, "15"),
    c: common_vendor.o(($event) => $data.form1.searchvalue = $event, "8d"),
    d: common_vendor.p({
      placeholder: "输入金额搜索",
      ["show-action"]: false,
      ["input-align"]: "center",
    ...
    j: common_vendor.o($options.nextPage, "7f"),
    k: common_vendor.p({
