...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o(($event) => $options.pageTo("list/list"), "40"),
    d: common_vendor.o(($event) => $options.add(), "4a"),
    e: common_vendor.o(($event) => $options.adds(), "a0"),
    f: common_vendor.o(($event) => $options.count(), "67"),
    g: common_vendor.o(($event) => $options.del(), "5f"),
    h: common_vendor.o(($event) => $options.findById(), "a6"),
    i: common_vendor.o(($event) => $options.findByWhereJson(), "e6"),
    j: common_vendor.o(($event) => $options.getList1(), "1b"),
    k: common_vendor.o(($event) => $options.selects(), "fe"),
    l: common_vendor.o(($event) => $options.sample(), "73"),
    m: common_vendor.o(($event) => $options.update(), "be"),
    n: common_vendor.o(($event) => $options.updateById(), "17"),
    o: common_vendor.o(($event) => $options.updateAndReturn(), "57"),
    p: common_vendor.o(($event) => $options.groupCount(), "7f"),
    q: common_vendor.o(($event) => $options.sum(), "43"),
    r: common_vendor.o(($event) => $options.avg(), "06"),
    s: common_vendor.o(($event) => $options.max(), "70"),
    t: common_vendor.o(($event) => $options.min(), "c4"),
    v: common_vendor.o(($event) => $options.getGeoList(), "40"),
