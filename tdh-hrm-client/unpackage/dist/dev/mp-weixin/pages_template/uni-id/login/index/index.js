...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o(($event) => $data.form1.username = $event.detail.value, "5c"),
    d: $data.form1.password,
    e: common_vendor.o(($event) => $data.form1.password = $event.detail.value, "8e"),
    f: common_vendor.o((...args) => $options.login && $options.login(...args), "0d"),
    g: common_vendor.o($options.login_weixin, "50"),
    h: common_vendor.p({
      name: "weixin-fill",
      size: "80",
      color: "#19be6b"
