...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o(($event) => $data.form.name = $event, "dd"),
    b: common_vendor.p({
    ...
    d: common_vendor.o(($event) => $data.form.intro = $event, "24"),
    e: common_vendor.p({
    ...
    i: common_vendor.o($options.submit, "c6"),
    j: common_vendor.o(($event) => $data.show = true, "b6")
  };
}
