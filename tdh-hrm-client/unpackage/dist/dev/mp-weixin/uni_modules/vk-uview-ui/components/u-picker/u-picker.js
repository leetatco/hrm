...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: $props.cancelColor,
    c: common_vendor.o(($event) => $options.getResult("cancel"), "f2"),
    d: common_vendor.t($props.title),
    e: common_vendor.t($props.confirmText),
    f: $data.moving ? $props.cancelColor : $props.confirmColor,
    g: common_vendor.o((...args) => $options.stop && $options.stop(...args), "69"),
    h: common_vendor.o(($event) => $options.getResult("confirm"), "ac"),
    i: common_vendor.o((...args) => $options.stop && $options.stop(...args), "e2"),
    j: $props.mode == "region"
    ...
    q: $data.valueArr,
    r: common_vendor.o((...args) => $options.change && $options.change(...args), "c2"),
    s: common_vendor.o((...args) => $options.pickstart && $options.pickstart(...args), "51"),
    t: common_vendor.o((...args) => $options.pickend && $options.pickend(...args), "3c")
    ...
    O: $data.valueArr,
    P: common_vendor.o((...args) => $options.change && $options.change(...args), "71"),
    Q: common_vendor.o((...args) => $options.pickstart && $options.pickstart(...args), "a2"),
    R: common_vendor.o((...args) => $options.pickend && $options.pickend(...args), "3d")
    ...
    V: $data.valueArr,
    W: common_vendor.o((...args) => $options.change && $options.change(...args), "3c"),
    X: common_vendor.o((...args) => $options.pickstart && $options.pickstart(...args), "d8"),
    Y: common_vendor.o((...args) => $options.pickend && $options.pickend(...args), "87")
    ...
    ac: $data.valueArr,
    ad: common_vendor.o((...args) => $options.change && $options.change(...args), "a3"),
    ae: common_vendor.o((...args) => $options.pickstart && $options.pickstart(...args), "0c"),
    af: common_vendor.o((...args) => $options.pickend && $options.pickend(...args), "10")
  }) : {}, {
    v: $props.mode == "time",
    S: $props.mode == "selector",
    Z: $props.mode == "multiSelector",
    ag: common_vendor.o($options.close, "d5"),
    ah: common_vendor.o(($event) => $data.popupValue = $event, "fe"),
    ai: common_vendor.p({
