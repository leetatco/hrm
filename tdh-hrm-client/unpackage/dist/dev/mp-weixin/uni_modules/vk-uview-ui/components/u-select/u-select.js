...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    m: common_vendor.o((...args) => $options.columnChange && $options.columnChange(...args), "53"),
    n: $data.defaultSelector,
    o: common_vendor.o((...args) => $options.pickstart && $options.pickstart(...args), "bd"),
    p: common_vendor.o((...args) => $options.pickend && $options.pickend(...args), "0a")
  }) : {}, {
    q: common_vendor.o($options.close, "79"),
    r: common_vendor.o(($event) => $data.popupValue = $event, "4a"),
    s: common_vendor.p({
      blur: $props.blur,
