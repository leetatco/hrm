...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    l: common_vendor.o((...args) => $options.cancel && $options.cancel(...args), "b8")
  } : {}, {
    ...
    t: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "76")
  }) : {}) : {}, {
    v: common_vendor.o($options.popupClose, "95"),
    w: common_vendor.o(($event) => $data.popupValue = $event, "fc"),
    x: common_vendor.p({
      blur: $props.blur,
      zoom: $props.zoom,
      mode: "center",
