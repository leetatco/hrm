...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: common_vendor.o((...args) => $options.getphonenumber && $options.getphonenumber(...args), "1f"),
    D: common_vendor.o((...args) => $options.getuserinfo && $options.getuserinfo(...args), "77"),
    E: common_vendor.o((...args) => $options.error && $options.error(...args), "a2"),
    F: common_vendor.o((...args) => $options.opensetting && $options.opensetting(...args), "b5"),
    G: common_vendor.o((...args) => $options.launchapp && $options.launchapp(...args), "40"),
    H: common_vendor.o((...args) => $options.chooseavatar && $options.chooseavatar(...args), "be"),
    I: common_vendor.s($props.customStyle),
    J: common_vendor.s({
      overflow: $props.ripple ? "hidden" : "visible"
    }),
    K: common_vendor.o(($event) => $options.click($event), "cb"),
