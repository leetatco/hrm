  ...
  methods: {
    ...
    chooseFiles() {
      ...
      common_vendor.wr.chooseAndUploadFile({
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:373", "选择失败", err);
      });
    },
    /**
     * 选择文件回调
    ...
    uploadFiles(files) {
      ...
      return uni_modules_uniFilePicker_components_uniFilePicker_chooseAndUploadFile.uploadCloudFiles.call(this, files, 5, (res) => {
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:461", err);
      });
    },
    /**
     * 成功或失败
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o($options.uploadFiles, "a8"),
    g: common_vendor.o($options.choose, "55"),
    h: common_vendor.o($options.delFile, "4c"),
    i: common_vendor.p({
    ...
    k: common_vendor.o($options.uploadFiles, "5c"),
    l: common_vendor.o($options.choose, "08"),
    m: common_vendor.o($options.delFile, "37"),
    n: common_vendor.p({
      readonly: $props.readonly,
