	...
	export default {
		...
		methods: {
			...
			search() {
				...
				if (formData.grant_date_start && formData.grant_date_end) {
					formData.grant_date = {
						$gte: formData.grant_date_start,
						$lte: formData.grant_date_end
					};
				} else if (formData.grant_date_start) {
					formData.grant_date = {
						$gte: formData.grant_date_start
					};
				} else if (formData.grant_date_end) {
					formData.grant_date = {
						$lte: formData.grant_date_end
					};
				}
				// 删除临时字段
				delete formData.grant_date_start;
				delete formData.grant_date_end;
