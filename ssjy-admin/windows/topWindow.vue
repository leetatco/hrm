<template>
	<view class="header no-user-select" :class="showMenuTabs ? 'show-menu-tabs':'hide-menu-tabs'"
		v-loading="!vk.getVuex('$app.inited')" :style="'--textColor'+textColor">
		<!-- 左侧 -->
		<view class="left">
			...
			<navigator class="logo-mode-2" open-type="reLaunch" url="/">
				<view class="logo-box" v-show="!vk.getVuex('$app.leftCollapse')">
					...
					<view class="app-name">食品安全追溯平台</view>
				</view>
				<view class="logo-box" v-show="vk.getVuex('$app.leftCollapse')">
