...
const config = {
  ...
  interceptor: {
    ...
    // 	//uni.__f__('log','at app.config.js:165',"params:",params);
    // 	//uni.__f__('log','at app.config.js:166',"res:",res);
    // 	if (!params.noAlert) {
    // 		vk.alert(res.msg);
    // 	}
    // 	uni.__f__('log','at app.config.js:170',"跳自己的登录页面");
    // 	// 上方代码可自己修改，写成你自己的逻辑处理。
    // },
    // fail(obj) {
    // 	let { vk, params, res } = obj;
    // 	//uni.__f__('log','at app.config.js:176',"params:",params);
    // 	//uni.__f__('log','at app.config.js:177',"res:",res);
    // 	return false; // 返回false则取消框架内置fail的逻辑，返回true则会继续执行框架内置fail的逻辑
    // 	// 上方代码可自己修改，写成你自己的逻辑处理。
    // }
    // navigateTo(obj) {
    // 	let { pagePath } = obj;
    // 	uni.__f__('log','at app.config.js:184',"pagePath:", pagePath);
...
//# sourceMappingURL=../.sourcemap/mp-weixin/app.config.js.map
