...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o((...args) => $options.subscribeMessage1 && $options.subscribeMessage1(...args), "4d"),
    b: common_vendor.o((...args) => $options.subscribeMessage2 && $options.subscribeMessage2(...args), "6c"),
    c: common_vendor.o((...args) => $options.sendMessage && $options.sendMessage(...args), "db"),
