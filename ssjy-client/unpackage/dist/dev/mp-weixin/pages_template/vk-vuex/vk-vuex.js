...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.o(($event) => $data.form1.username = $event.detail.value, "a2"),
    f: $data.form1.password,
    g: common_vendor.o(($event) => $data.form1.password = $event.detail.value, "06"),
    h: common_vendor.o((...args) => $options.register && $options.register(...args), "3d"),
    i: common_vendor.o((...args) => $options.login && $options.login(...args), "a9"),
    j: common_vendor.o((...args) => $options.uploadAvatar && $options.uploadAvatar(...args), "47"),
    k: common_vendor.o((...args) => $options.logout && $options.logout(...args), "dd")
  });
}
