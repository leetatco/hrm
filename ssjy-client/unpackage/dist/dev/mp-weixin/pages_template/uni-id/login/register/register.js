...
const _sfc_main = {
  ...
  methods: {
    // 页面数据初始化函数
    init(options = {}) {
      common_vendor.index.__f__("log", "at pages_template/uni-id/login/register/register.vue:112", "init: ", options);
    },
    pageTo(path) {
      vk.navigateTo(path);
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $data.logoImage,
    b: $data.form1.mobile,
    c: common_vendor.o(($event) => $data.form1.mobile = $event.detail.value, "0e"),
    d: $data.form1.password,
    e: common_vendor.o(($event) => $data.form1.password = $event.detail.value, "f8"),
    f: $data.form1.password2,
    g: common_vendor.o(($event) => $data.form1.password2 = $event.detail.value, "4d"),
    h: $data.form1.code,
    i: common_vendor.o(($event) => $data.form1.code = $event.detail.value, "46"),
    j: common_vendor.p({
      seconds: "60",
    ...
    k: common_vendor.o((...args) => $options.loginBySms && $options.loginBySms(...args), "4b"),
    l: $data.form1.agreement,
    m: common_vendor.o((...args) => $options.checkboxChange && $options.checkboxChange(...args), "2e")
  };
}
