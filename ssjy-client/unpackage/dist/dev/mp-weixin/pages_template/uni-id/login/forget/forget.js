...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $data.form1.mobile,
    b: common_vendor.o(($event) => $data.form1.mobile = $event.detail.value, "21"),
    c: $data.form1.password,
    d: common_vendor.o(($event) => $data.form1.password = $event.detail.value, "57"),
    e: $data.form1.password2,
    f: common_vendor.o(($event) => $data.form1.password2 = $event.detail.value, "f8"),
    g: $data.form1.code,
    h: common_vendor.o(($event) => $data.form1.code = $event.detail.value, "ef"),
    i: common_vendor.p({
    ...
    j: common_vendor.o((...args) => $options.resetPassword && $options.resetPassword(...args), "a4")
  };
}
