...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.setAvatar && $options.setAvatar(...args), "46"),
    d: common_vendor.o((...args) => $options.uploadAvatar && $options.uploadAvatar(...args), "6d"),
    e: common_vendor.o((...args) => $options.updateUser && $options.updateUser(...args), "30"),
    f: common_vendor.o((...args) => $options.getMyUserInfo && $options.getMyUserInfo(...args), "08"),
    g: common_vendor.o((...args) => $options.checkToken && $options.checkToken(...args), "39"),
    h: common_vendor.o((...args) => $options.setUserInviteCode && $options.setUserInviteCode(...args), "38"),
    i: $data.form1.inviteCode,
    j: common_vendor.o(($event) => $data.form1.inviteCode = $event.detail.value, "f1"),
    k: common_vendor.o((...args) => $options.acceptInvite && $options.acceptInvite(...args), "4e"),
    l: common_vendor.o((...args) => $options.logout && $options.logout(...args), "3e")
  });
}
