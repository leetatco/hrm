...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o($options.uploadFiles, "0e"),
    g: common_vendor.o($options.choose, "70"),
    h: common_vendor.o($options.delFile, "50"),
    i: common_vendor.p({
    ...
    k: common_vendor.o($options.uploadFiles, "b9"),
    l: common_vendor.o($options.choose, "00"),
    m: common_vendor.o($options.delFile, "3a"),
    n: common_vendor.p({
      readonly: $props.readonly,
