...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o($options.maskClick, "10"),
    c: common_vendor.p({
      blur: $props.blur,
    ...
    f: common_vendor.o($options.close, "bc"),
    ...
    n: common_vendor.o((...args) => $options.close && $options.close(...args), "fb"),
    o: common_vendor.n("u-close--" + $props.closeIconPos),
    p: common_vendor.o(($event) => $options.modeCenterClose($props.mode), "21"),
