...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: common_vendor.o((...args) => $options.getphonenumber && $options.getphonenumber(...args), "e2"),
    D: common_vendor.o((...args) => $options.getuserinfo && $options.getuserinfo(...args), "91"),
    E: common_vendor.o((...args) => $options.error && $options.error(...args), "ae"),
    F: common_vendor.o((...args) => $options.opensetting && $options.opensetting(...args), "a1"),
    G: common_vendor.o((...args) => $options.launchapp && $options.launchapp(...args), "9c"),
    H: common_vendor.o((...args) => $options.chooseavatar && $options.chooseavatar(...args), "10"),
    I: common_vendor.s($props.customStyle),
    J: common_vendor.s({
      overflow: $props.ripple ? "hidden" : "visible"
    }),
    K: common_vendor.o(($event) => $options.click($event), "6a"),
