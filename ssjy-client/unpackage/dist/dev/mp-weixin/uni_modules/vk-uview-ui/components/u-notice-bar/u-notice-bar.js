...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o($options.getMore, "73"),
    d: common_vendor.o($options.close, "23"),
    e: common_vendor.o($options.click, "12"),
    f: common_vendor.p({
      type: $props.type,
      color: $props.color,
    ...
    h: common_vendor.o($options.getMore, "5d"),
    i: common_vendor.o($options.close, "a3"),
    j: common_vendor.o($options.click, "25"),
    k: common_vendor.o($options.end, "72"),
    l: common_vendor.p({
      type: $props.type,
      color: $props.color,
      bgColor: $props.bgColor,
